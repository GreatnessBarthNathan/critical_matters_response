...
export default function InvitationPage() {
  ...
  if (state === 'recovery') {
    return (
      ...
      >
        ...
        <RecoveryCodes
          codes={recoveryCodes}
          onAcknowledge={() => navigate('/app', { replace: true })}
        />
      </AuthLayout>
    )
  }
  ...
  return (
    <AuthLayout
      ...
      subtitle={`Invitation for ${invitation?.email ?? 'your address'}.`}
    >
      ...
      <form className='stack-form' onSubmit={submit}>
        ...
        <label className='check-label'>
          <input type='checkbox' required />I understand each matter I share is
          visible only to me and RPN.
        </label>
