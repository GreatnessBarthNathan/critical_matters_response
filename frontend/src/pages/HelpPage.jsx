...
const QUESTIONS = [
  ...
  ['How do I get back in without email?', 'This service sends no email. Use one of the recovery codes you saved when your account was created. If you no longer have them, ask Tech Support for a one-time reset code — they will verify who you are first.'],
  ...
  ['Why do I need an authenticator app?', 'It is required for the admin account and optional for leaders. It means a stolen password alone is not enough to read anyone’s matters.'],
  ['How do I join?', 'Only by invitation from Tech Support. There is no public sign-up.'],
];
  ...
  return (
    <div className="help-page">
      ...
      <p className="help-footer">
        <LifeBuoy size={17} aria-hidden="true" /> Still need help? Contact Tech Support directly.
      </p>
    </div>
  );
}
